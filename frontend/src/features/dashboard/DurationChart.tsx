...
export default function DurationChart({ confirmedStays }: DurationChartProps) {
  ...
  return (
    <Box className='flex rounded-lg bg-grey-50 p-8 shadow-md dark:bg-dark-grey-100/40 dark:shadow-none lg:flex-col lg:items-center 2xl:flex-row'>
      <DonutChart
        data={data}
        withTooltip
