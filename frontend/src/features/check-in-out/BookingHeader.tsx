...
export default function BookingHeader({ booking }: BookingProp) {
  ...
  return (
    <Box className='flex flex-col items-center justify-between rounded-lg bg-indigo-700 p-4 text-grey-200 md:flex-row'>
      ...
      <Text className='text-grey-500 dark:text-dark-grey-500 md:text-lg md:text-grey-200 md:dark:text-dark-grey-700'>
